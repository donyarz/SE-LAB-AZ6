# SE-LAB-AZ6
فاز اول آرمایش در برنچ main قرار دارد و فاز دوم در برنچ MiniJava البته کامیت های مربوط به عملیات refactoring برای فاز دوم در برنج Project2 قرار دارد و تنها فایل نهایی آن بر روی MiniJava است.
بدلیل اینکه فایل نهایی project2 بر روی هر سیستمی اجرا نمیشد و یک نسخه یهتری اضافه کردیم که تفاوتی با قبلی ندارد و فقط یکسری تنظیمات آن بهتر شده است. بنابراین نسخه نهایی فاز دو پروژه را بر روی یک برنچ دیگر یعنی MiniJava پوش کنیم.
